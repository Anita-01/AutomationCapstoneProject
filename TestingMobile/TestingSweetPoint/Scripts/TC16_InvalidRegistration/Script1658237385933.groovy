...
for (i = 0; i < 5; i++) {
    ...
    Mobile.setText(findTestObject('Object Repository/Registration/android.widget.EditText - Name (1)'), name[i], 0)

    Mobile.tap(findTestObject('Object Repository/Registration/android.widget.EditText - Username'), 0)

    Mobile.setText(findTestObject('Object Repository/Registration/android.widget.EditText - Username (1)'), username[i], 
        0)

    Mobile.tap(findTestObject('Object Repository/Registration/android.widget.EditText - Email'), 0)

    Mobile.setText(findTestObject('Object Repository/Registration/android.widget.EditText - Email (1)'), email[i], 0)

    Mobile.tap(findTestObject('Object Repository/Registration/android.widget.EditText - Password'), 0)

    Mobile.setText(findTestObject('Object Repository/Registration/android.widget.EditText - PasswordPassword'), password[
        i], 0)
    ...
    Mobile.setText(findTestObject('Object Repository/Registration/android.widget.EditText - Address (1)'), address[i], 0)

    Mobile.pressBack()

    Mobile.tap(findTestObject('Object Repository/Registration/android.widget.EditText - Phone'), 0)

    Mobile.setText(findTestObject('Object Repository/Registration/android.widget.EditText - Phone (1)'), phone[i], 0)
