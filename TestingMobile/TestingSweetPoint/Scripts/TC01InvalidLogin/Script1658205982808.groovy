...
Mobile.setText(findTestObject('Object Repository/NewLogin/android.widget.EditText - Username'), username[i], 0)

Mobile.pressBack()

Mobile.tap(findTestObject('Object Repository/NewLogin/android.widget.EditText - Password'), 0)

Mobile.setText(findTestObject('Object Repository/NewLogin/android.widget.EditText - PasswordPassword'), password[i], 0)
