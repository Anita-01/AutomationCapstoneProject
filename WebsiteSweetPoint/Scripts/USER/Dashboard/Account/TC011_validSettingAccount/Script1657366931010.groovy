...
WebUI.setText(findTestObject('Website/DashboardAdmin/AccountSetting (1)/Username'), 'Anita01')

WebUI.setText(findTestObject('Website/DashboardAdmin/AccountSetting (1)/Email'), 'anitasiagian123@gmail.com')

WebUI.setText(findTestObject('Website/DashboardAdmin/AccountSetting (1)/Password'), 'Anita')

WebUI.setText(findTestObject('Website/DashboardAdmin/AccountSetting (1)/confirmPassword'), 'Anita')
